...
class LinkedList:
    """
    A linked list of polynomial terms.
    """
    def __init__(self):
    ...
    def add(self, p):
        """
        Add a polynomial p to the polynomial and return the resulting polynomial 
    ...
    def mult(self, p):
        """
        Multiply two polynomials p with the polynomial, return the product as a new linked list.
        """
        result = LinkedList()
